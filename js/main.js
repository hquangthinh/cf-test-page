window.PbsArmLauncherApp = (function ($, axios) {
  ...
  $(document).ready(function () {
    ...
    //console.log(`ARMLauncher is ready`);
    ...
    if (saveConfigBtn) {
      saveConfigBtn.addEventListener("click", function (event) {
        ...
        saveArmConfiguration(txtBaseUrl.value);
      }, false);
    }
  ...
  function getArmConfiguration() {
    ...
    httpClient.get(`/api/v1/Ice.BO.UD100Svc/GetRows?whereClauseUD100=${whereClauseUD100}&whereClauseUD100Attch=&whereClauseUD100A=&whereClauseUD100AAttch=&pageSize=1&absolutePage=1`)
